...
const Home = () => {
  return (
    ...
    <div className=" flex flex-col items-center w-auto h-screen p-10  m-auto bg-[#ffffff]">
      ...
      <a href="/googleauth" className="items-center">
        <button className="text-white bg-black hover:bg-[#b52e2b] h-20 w-38 focus:ring-4 focus:outline-none focus:ring-white font-medium rounded-lg text-med px-5 py-3 text-center inline-flex items-center">
      ...
      <a href="/googleauth" className="items-center p-5">
        <button className="text-white bg-black hover:bg-[#b52e2b] h-20 w-38 focus:ring-4 focus:outline-none focus:ring-white font-medium rounded-lg text-med px-5 py-3 text-center inline-flex items-center">
          Continue with alternate Email
          <svg
            aria-hidden="true"
            class="w-5 h-5 ml-2 -mr-1"
            fill="currentColor"
